    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[#f4f7fb] dark:bg-[#020617] p-6 transition-colors duration-300">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                type="text"
                                placeholder="Логин"
                                className="w-full h-14 pl-12 pr-4 bg-slate-50 dark:bg-[#020617] border border-slate-200 dark:border-slate-800 rounded-2xl outline-none text-slate-900 dark:text-white font-semibold focus:border-blue-500 transition-all text-sm"
                                value={username}
                        ...
                        <div className="relative group">
                            ...
                            <input
                                type="password"
                                placeholder="Пароль"
                                className={`w-full h-14 pl-12 pr-4 bg-slate-50 dark:bg-[#020617] border rounded-2xl outline-none text-slate-900 dark:text-white font-semibold transition-all text-sm ${error ? 'border-red-500 animate-shake' : 'border-slate-200 dark:border-slate-800 focus:border-blue-500'}`}
                                value={password}
                        ...
                        <button
                            type="submit"
                            className="w-full h-14 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-2xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:-translate-y-0.5 active:scale-95 transition-all mt-6 cursor-pointer"
                        >
            ...
            <style>{`
                ...
                .animate-shake { animation: shake 0.2s ease-in-out ease 0s 2; }
            `}</style>
        </div>
    )
}
